...
class book_store
{
  ...
  void education()
  {
      while(true)
      {
          ...
          System.out.println("1.Understanding Computer Applications with BlueJ[Class X](Arya Publishing Company)--------Rs.425.00");
          System.out.println("2.Understanding ICSE Mathematics[Class X](Avichal Publishing Company)---------------------Rs.400.00");
          System.out.println("3.New ICSE History & Civics[Class X](Frank Bros.&Co.)-------------------------------------Rs.370.00");
          System.out.println("4.Modern Certificate Geography[Class X](Frank Bros.&Co.)----------------------------------Rs.485.00");
          System.out.println("5.Concise Physics[Class X](Selina Publishers)---------------------------------------------Rs.300.00");
          System.out.println("6.Concise Chemistry[Class X](Selina Publishers)-------------------------------------------Rs.270.00");
          System.out.println("7.Concise Biology[Class X](Selina Publishers)---------------------------------------------Rs.340.00");
          System.out.println("8.The Merchant of Venice(Selina Publishers)-----------------------------------------------Rs.125.00");
          System.out.println("9.ICSE A Collection of Poems and Short Stories(Inter University Press)--------------------Rs.10.08");
          System.out.println("10.Total English[Class X](Morning Star Publications)--------------------------------------Rs.225.00");
  ...
  public static void main(String args[])
  {
      ...
      for(i=0;i<30;i++)
      {
          ...
          {
              a++;
              System.out.println(a+"\t"+ob.name[i]+"\t Rs."+ob.price[i]+"\t"+ob.q[i]+"\t"+ob.dis[i]+"\t Rs."+ob.dis_am[i]+"\t Rs."+ob.s[i]);
          }
      }
      System.out.println("-----------------------------------------------Total= Rs."+ob.total);
      in.close();
  }
}
